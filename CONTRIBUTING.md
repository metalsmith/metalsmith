...
If you would like to get in touch for a question, an announcement or advice, please drop us a message in the [gitter community chat](https://app.gitter.im/#/room/#metalsmith_community:gitter.im). We'd love to see how Metalsmith has helped you or how we can help you with Metalsmith.
...
All core plugins use the same dev setup: mocha for testing, release-it and auto-changelog for managing Git & Github releases, Github Actions and coveralls for continuous integration, and eslint and prettier for code style.

The README files of core plugins all have the same structure: Short description matching package.json & Github description, badges, an optional features section, a longer description, _Usage_ section (with examples, _Debug_ and _CLI Usage_ sub-sections at the end), credits (when applicable) and _License_.
