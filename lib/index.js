...
var frontmatter = require('./metalsmith-frontmatter.js');
...
Metalsmith.prototype.readFile = unyield(function*(file){
  ...
  try {
    ret.stats = yield fs.stat(file);
    ret.contents = yield fs.readFile(file);
  ...
  if (this.frontmatter()) frontmatter.extractFrontmatter(ret, file);
