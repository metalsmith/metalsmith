...
/**
 * @typedef {string|string[]|Record<string, string>} StaticPaths
 */

/**
 *
 * @param {StaticPaths} paths
 * @returns {string[]|string|Metalsmith}
 */
Metalsmith.prototype.static = function (paths) {
  if (!arguments.length) return this[symbol.static].spec
