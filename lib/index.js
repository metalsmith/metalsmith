...
Metalsmith.prototype.frontmatter = function(frontmatter){
  ...
  assert(isBoolean(frontmatter) || isObject(frontmatter), 'You must pass a boolean or a gray-matter options object: https://github.com/jonschlinkert/gray-matter/tree/4.0.2#options')
...
Metalsmith.prototype.read = unyield(function*(dir){
  ...
  var result = paths.reduce(memoizer, {})
  this._files = result
  return result
